module.exports = function(app){
  ...
  var Facebook = require("temboo/Library/Facebook/OAuth");
  var finalizeOAuth = new Facebook.FinalizeOAuth(common.session);
  var initializeOAuth = new Facebook.InitializeOAuth(common.session);
  var finalizeOAuthInputs = finalizeOAuth.newInputSet();
  var initializeOAuthInputs = initializeOAuth.newInputSet();
  initializeOAuthInputs.set_AppID(common.consumerKey);
